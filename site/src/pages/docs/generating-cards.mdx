...
Daily Review creates flashcards by analyzing your Claude Code conversations. There are two ways to generate cards.
...
The skill scans your recent conversations (stored as JSONL in `~/.claude/projects/`), extracts key concepts, and generates flashcards. It then uploads them to your Daily Review account.
